...
public class Money implements Comparable {
	...
	public String toString() {
		...
		double amountInDecimal = Math.round((double) amount) / 100.0;
		String result = df.format(amountInDecimal).replace(".", ",");

		return result + " " + currency.getName();
	}
	...
	public Money sub(Money other) {
		int diff = amount - currency.valueInThisCurrency(other.amount, currency);
	...
	public int compareTo(Object other) {
		if (other instanceof Money) {
			...
			throw new IllegalArgumentException("Object is not of type Money");
		}
	}
}